...
const index = () => {
  ...
  const blueComponent = blueStart + (blueEnd - blueStart) * (circleRadius / 10);
          ...
          <Svg height={deviceWidth + 50} width={deviceWidth}>
            ...
            <Defs>
              ...
              >
                ...
                <Stop offset="100%" stopColor={animatedColor} stopOpacity="1" />
              </RadialGradient>
            </Defs>
            ...
            <Circle
              cx={deviceWidth / 2}
              cy={deviceWidth / 2 + 25}
              r={Math.max((circleRadius * 18) / 1.5 + 15, minRadius)}
              fill="url(#grad)"
              fillOpacity="0.6"
            />
            {/* inner circle */}
